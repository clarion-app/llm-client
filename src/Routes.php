...
Route::group(['middleware'=>'auth:api', 'prefix'=>'api/clarion-app/llm-client' ], function () {
    ...
    Route::get('server-group/{server_group_id}/model', [LanguageModelController::class, "index"]);
    Route::post('models/{server_group_id}/refresh', [LanguageModelController::class, "refresh"]);
