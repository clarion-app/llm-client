...
Route::group(['middleware'=>'auth:api', 'prefix'=>$this->routePrefix ], function () {
    ...
    Route::patch('coding-project/{id}/resource-limits', [CodingProjectController::class, "updateResourceLimits"]);
    ...
    Route::get('coding-project/{project}/languages', [CodingWorkspaceController::class, "languages"]);
