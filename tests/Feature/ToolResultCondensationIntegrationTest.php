...
class ToolResultCondensationIntegrationTest extends TestCase
{
    ...
    protected function defineDatabaseMigrations(): void
    {
        ...
        Schema::create('conversations', function (Blueprint $table) {
            ...
            $table->timestamps();
            // Conversation uses EloquentMultiChainBridge, which pulls in
            // Laravel's SoftDeletes trait — every query against this table
            // (including Message's new attribution-stamping creating
            // listener, 093-agent-handoff) filters on deleted_at whether
            // or not this fixture ever soft-deletes a row.
            $table->softDeletes();
        });
